...
class EditEventAdminDialog extends ConsumerStatefulWidget {
  const EditEventAdminDialog({super.key, required this.event, this.onSaved});

  final EventAdminModel event;
  final VoidCallback? onSaved;

  @override
  ConsumerState<EditEventAdminDialog> createState() =>
      _EditEventAdminDialogState();
}

class _EditEventAdminDialogState extends ConsumerState<EditEventAdminDialog> {
  ...
  void initState() {
    ...
    _xController = TextEditingController(
      text: widget.event.locationX.toString(),
    );
    _yController = TextEditingController(
      text: widget.event.locationY.toString(),
    );
    _pictureUrl = widget.event.eventPicture;
  }
