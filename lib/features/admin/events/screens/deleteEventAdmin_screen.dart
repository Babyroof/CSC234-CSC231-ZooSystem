...
class DeleteEventAdminDialog extends ConsumerStatefulWidget {
  const DeleteEventAdminDialog({
    super.key,
    required this.event,
    this.onDeleted,
  });
  ...
  @override
  ConsumerState<DeleteEventAdminDialog> createState() =>
      _DeleteEventAdminDialogState();
}

class _DeleteEventAdminDialogState
    extends ConsumerState<DeleteEventAdminDialog> {
