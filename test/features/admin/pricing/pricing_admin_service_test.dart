...
void main() {
  ...
  // ── getPricing ────────────────────────────────────────────────────────────
  group('getPricing', () {
    test('returns adultPrice, childPrice, elderPrice from config/pricing doc', () async {
      // Arrange
    ...
    test('returns BookingPricing fallback values when config/pricing doc does not exist', () async {
    ...
    test('returns BookingPricing fallback for individual field if field is missing from doc', () async {
  ...
  // ── updatePricing ─────────────────────────────────────────────────────────
  group('updatePricing', () {
    test('writes adultPrice, childPrice, elderPrice to config/pricing', () async {
      ...
      // Assert
      final data = (await fakeDb.collection('config').doc('pricing').get()).data()!;
    ...
    test('updatePricing uses merge so a pre-existing unrelated field survives', () async {
